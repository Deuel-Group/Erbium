package com.jmsgvn.erbium.punishments;
...
import com.jmsgvn.erbium.utils.Notifications;
import com.jmsgvn.erbium.utils.PlayerUtil;
import com.jmsgvn.erbium.utils.TimeUtil;
import com.jmsgvn.erbium.utils.WebHook;
import lombok.Data;
...
public @Data class Punishment {
    ...
    public enum Type {
        ...
        public String permission(Erbium plugin) {
            switch(this) {
                case BAN:
        ...
        public Button getButton(Erbium plugin, Punishment punishment) {
        ...
        public void action(Erbium plugin, String expiry, String duration, String issueReason, Player player) {

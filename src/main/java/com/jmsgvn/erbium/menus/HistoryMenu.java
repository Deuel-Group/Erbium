...
import com.jmsgvn.erbium.listeners.PromptListener;
...
public class HistoryMenu {
    public static void openHistoryMenu(Erbium plugin, Player staff, Profile targetProfile, String notes) {
    ...
    private static Button createButton(Erbium plugin, Punishment punishment) {

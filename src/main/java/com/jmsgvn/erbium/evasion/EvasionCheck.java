...
public @Data class EvasionCheck {
    ...
    public EvasionCheck(UUID uuid, String ip, Erbium plugin) {
        evading(uuid, ip, plugin);
    }

    public void evading(UUID uuid, String ip, Erbium plugin) {

...
import com.jmsgvn.punishments.utils.DocumentUtil;
...
public @Data class EvasionCheck {
    ...
    public EvasionCheck(UUID uuid, String ip, Punishments plugin) {
        evading(uuid, ip, plugin);
    }

    public void evading(UUID uuid, String ip, Punishments plugin) {

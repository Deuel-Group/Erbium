...
public class WebHook {
    public static void sendWebhook(Punishments plugin, UUID victimUUID, UUID punishmentUUID, String duration, String stack, String type, String victimName, String issueReason, String issuerName, String pardonReason, String expiry) {

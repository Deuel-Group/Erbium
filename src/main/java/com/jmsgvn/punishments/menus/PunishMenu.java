package com.jmsgvn.punishments.menus;
...
import com.jmsgvn.punishments.utils.Stackables;
import com.jmsgvn.punishments.utils.TranslatePunishment;
...
public class PunishMenu {
    ...
    public static void openPunishMenu(Punishments plugin, Player staff, Profile targetProfile, String notes) {
    ...
    public static Button createButton(Punishments plugin, Profile targetProfile, Player issuer, String notes, ConfigurationSection section) {

...
import com.jmsgvn.punishments.listeners.PromptListener;
...
public class HistoryMenu {
    public static void openHistoryMenu(Punishments plugin, Player staff, Profile targetProfile, String notes) {
    ...
    private static Button createButton(Punishments plugin, Punishment punishment) {

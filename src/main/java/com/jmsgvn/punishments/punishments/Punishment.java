...
import com.jmsgvn.punishments.utils.Notifications;
import com.jmsgvn.punishments.utils.PlayerUtil;
import com.jmsgvn.punishments.utils.TimeUtil;
import com.jmsgvn.punishments.utils.WebHook;
import lombok.Data;
...
public @Data class Punishment {
    ...
    public enum Type {
        ...
        public String permission(Punishments plugin) {
            switch(this) {
                case BAN:
        ...
        public Button getButton(Punishments plugin, Punishment punishment) {
        ...
        public void action(Punishments plugin, String expiry, String duration, String issueReason, Player player) {
